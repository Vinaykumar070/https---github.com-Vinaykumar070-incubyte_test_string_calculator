...
const StringCalculator: React.FC = () => {
  ...
  return (
    <div className="flex flex-col items-center min-h-screen bg-gradient-to-br from-orange-300 to-purple-400 p-6">
      <h2 className="py-4 px-32 text-sm mb-12 font-semibold text-white bg-gradient-to-r from-blue-500 to-green-500 rounded-xl shadow-lg hover:opacity-90 transition duration-300 transform hover:scale-105 flex space-x-4 mt-4">
